...
class PyeducApp:
    def __init__(self, page: ft.Page):
        ...
        # Pré-carregar o modelo LLM na VRAM em segundo plano ao iniciar o app
        self.page.run_thread(self.state.ollama_client.preload_model)
    ...
    def update_ui_strings(self, skip_lesson_select=False):
        ...
        self.btn_login.text = cm.get_ui_string("btn_login")
        self.btn_register.text = cm.get_ui_string("btn_register")
        self.welcome_title.value = cm.get_ui_string("lbl_welcome")
        self.welcome_subtitle.value = cm.get_ui_string("lbl_login_msg")
        self.btn_prev.text = cm.get_ui_string("btn_prev")
        self.btn_next.text = cm.get_ui_string("btn_next")
